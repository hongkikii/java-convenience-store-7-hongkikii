...
- [ ] 시작 안내 문구를 보여준다.
    - [ ] 안내 문구는 “`안녕하세요. W편의점입니다.`”이다.
- [ ] 재고 안내 문구와 재고를 보여준다.
    - [ ] 안내 문구는 “`현재 보유하고 있는 상품입니다.`”이다.
    - [ ] 재고는 “`- {상품명} {가격}원 {수량}개 {행사이름}`” 형태로 보여준다.
    - [ ] 오늘 날짜가 프로모션 기간 내에 포함된 경우 행사 상품을 보여준다.
    - [ ] 가격은 천원 단위로 쉼표(,)를 찍어 보여준다.
    - [ ] 만약 재고가 없을 시, “`재고 없음`”을 보여준다.

## 구매

- [ ] 구매 상품 및 수량 입력 안내 문구를 보여준다.
    - [ ] 안내 문구는 “`구매하실 상품명과 수량을 입력해 주세요. (예: [사이다-2],[감자칩-1])`”이다.
- [ ] 구매 상품과 수량을 입력받는다.
